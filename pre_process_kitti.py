...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='/home/student2/Documents/Datasets/View_of_Delft_dataset_PUBLIC/view_of_delft_PUBLIC', 
                        help='your data root for kitti')
    parser.add_argument('--prefix', default='Vod', 
